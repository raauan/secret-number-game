...
function exibirMensagemInicial() {
    ...
    exibirTextoNaTela('p', 'Pick a number between 1 and 100');
}
...
function verificarChute() {
    ...
    if (chute == numeroSecreto) {
        ...
        if (chute > numeroSecreto) {
            exibirTextoNaTela('p', 'The number is less than ' + chute);
        } else {
            exibirTextoNaTela('p', 'The number is greater than ' + chute);
        }
        tentativas++;
        limparCampo();
    }
